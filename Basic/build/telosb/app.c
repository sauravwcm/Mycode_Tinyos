...
extern void *memset(void *arg_0x10261f020, int arg_0x10261f2a0, size_t arg_0x10261f560);
#line 65
extern void *memset(void *arg_0x102637060, int arg_0x1026372e0, size_t arg_0x1026375a0);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x102677170);
  ...
  void (**_sig_func)(int arg_0x10267c480);
...
typedef TMilli BasicC__Timer0__precision_tag;
typedef TMilli BasicC__Timer1__precision_tag;
...
static void BasicC__Timer0__fired(void );
# 60 "../../tos/interfaces/Boot.nc"
static void BasicC__Boot__booted(void );
# 83 "../../tos/lib/timer/Timer.nc"
static void BasicC__Timer1__fired(void );
# 62 "../../tos/interfaces/Init.nc"
...
# 73 "../../tos/lib/timer/Timer.nc"
static void BasicC__Timer0__startOneShot(uint32_t dt);
#line 64
static void BasicC__Timer1__startPeriodic(uint32_t dt);
# 61 "../../tos/interfaces/Leds.nc"
static void BasicC__Leds__led0Off(void );
#line 83
static void BasicC__Leds__led1Toggle(void );
#line 117
static uint8_t BasicC__Leds__get(void );
#line 56
static void BasicC__Leds__led0On(void );
# 13 "BasicC.nc"
enum BasicC____nesc_unnamed4265 {

  BasicC__WARN_INTERVAL = 4096, BasicC__WARN_DURATION = 64
};
static inline void BasicC__Boot__booted(void );
...
static inline void BasicC__Timer1__fired(void );
...
# 39 "../../tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x102c4e8b0){
#line 39
  switch (arg_0x102c4e8b0) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x102c4e8b0);
#line 39
      break;
#line 39
    }
...
inline static void BasicC__Leds__led1Toggle(void ){
#line 83
...
# 83 "../../tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x1031563f0){
#line 83
  switch (arg_0x1031563f0) {
#line 83
    case 0U:
#line 83
      BasicC__Timer0__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      BasicC__Timer1__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x1031563f0);
#line 83
      break;
#line 83
    }
...
inline static uint8_t BasicC__Leds__get(void ){
#line 117
  unsigned char __nesc_result;
#line 117
...
# 61 "../../tos/interfaces/Leds.nc"
inline static void BasicC__Leds__led0Off(void ){
#line 61
...
#line 61
# 73 "../../tos/lib/timer/Timer.nc"
inline static void BasicC__Timer0__startOneShot(uint32_t dt){
#line 73
...
inline static void BasicC__Leds__led0On(void ){
#line 56
  LedsP__Leds__led0On();
#line 56
}
...
# 64 "../../tos/lib/timer/Timer.nc"
inline static void BasicC__Timer1__startPeriodic(uint32_t dt){
#line 64
...
static inline void BasicC__Boot__booted(void )
{
  BasicC__Timer1__startPeriodic(1000);
  BasicC__Timer0__fired();
}
...
# 75 "../../tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x102b6a170){
#line 75
  switch (arg_0x102b6a170) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x102b6a170);
#line 75
      break;
#line 75
    }
...
# 39 "../../tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x102c4e8b0){
#line 39
  switch (arg_0x102c4e8b0) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x102c4e8b0);
#line 39
      break;
#line 39
    }
...
static void BasicC__Timer0__fired(void )
{
  if (BasicC__Leds__get() & LEDS_LED0) 
    {
      BasicC__Leds__led0Off();
      BasicC__Timer0__startOneShot(BasicC__WARN_INTERVAL - BasicC__WARN_DURATION);
    }
  else 
    {
      BasicC__Leds__led0On();
      BasicC__Timer0__startOneShot(BasicC__WARN_DURATION);
    }
}
